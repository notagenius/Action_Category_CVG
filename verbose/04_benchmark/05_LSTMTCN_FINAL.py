...
def parse_command_line():
    ...
    parser.add_argument('-n', '--net', type=str, default='finalLTSMTCN_2', help='task to be trained')
    parser.add_argument('-f', '--file', type=str, default='finalLTSMTCN_2', help='tensorboard location')
    parser.add_argument('-r', '--runs', type=str, default='final/LTSMTCN_2', help='tensorboard location')
