...
def parse_command_line():
    ...
    parser.add_argument('-n', '--net', type=str, default='TCNnll', help='task to be trained')
    parser.add_argument('-f', '--file', type=str, default='TCNnll', help='tensorboard location')
    parser.add_argument('-r', '--runs', type=str, default='test/TCNnll', help='tensorboard location')
