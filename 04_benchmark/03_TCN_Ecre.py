...
def parse_command_line():
    ...
    parser.add_argument('-n', '--net', type=str, default='finalTCNerco', help='task to be trained')
    parser.add_argument('-f', '--file', type=str, default='finalTCNerco', help='tensorboard location')
    parser.add_argument('-r', '--runs', type=str, default='final/TCNerco', help='tensorboard location')
